...
protected:
	...
	unsigned int current_position;          //current betting position
	bool all_player_check = false;          // player check and chip out
	unsigned int num_player_fold = 0;       //record number of players fold
