...
//after betting phase
int TexasHoldEm::after_betting(vector<string> winners){
...
//find best five cards for all players
...
//print sorted player
vector<string> TexasHoldEm::print_sorted_player(){
	cout << endl;
	cout << "///////////////////////////////////////////////" << endl;
